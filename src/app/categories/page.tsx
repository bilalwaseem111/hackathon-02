  ...
  return (
    <div className="w-full flex">
      <div className="first hidden sm:flex w-[20%]">
        <Image src={"/Nav Bar Side.png"} alt="" width={330} height={1500} />
      </div>
            ...
            {[
              ...
              >
                ...
                <CardFooter className="w-full flex items-center justify-between">
                  ...
                  <Link href={"/details"}>
                    <button className="bg-[#e150d8] p-2 text-white rounded-md">
                      Rent Now
                    </button>
                  </Link>
                </CardFooter>
